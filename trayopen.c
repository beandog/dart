...
/**
 * Simple C script to detect if a tray is open! :D
 *
 * Found here:
 * http://www.linuxquestions.org/questions/slackware-14/detect-cd-tray-status-4175450610/
 * Written by volkerdi, Slackware maintainer
 */
